...
CREATE OR REPLACE FUNCTION public.normalize_public_catalog_audience(p_audience text)
RETURNS text
LANGUAGE sql
IMMUTABLE
SET search_path = ''
...
CREATE OR REPLACE FUNCTION public.list_public_clothing_categories(
  p_audience text,
...
CREATE OR REPLACE FUNCTION public.list_public_audience_sellers(
  p_audience text,
...
CREATE OR REPLACE FUNCTION public.list_public_trending_products(
  p_audience text,
...
CREATE OR REPLACE FUNCTION public.list_public_featured_sellers(
  p_audience text,
...
CREATE OR REPLACE FUNCTION public.list_public_category_products(
...
CREATE OR REPLACE FUNCTION public.list_public_category_sellers(
  p_category_slug text,
  p_audience text,
...
CREATE OR REPLACE FUNCTION public.list_public_seller_products(
  p_seller_slug text,
  p_audience text,
  p_limit integer DEFAULT 100
)
